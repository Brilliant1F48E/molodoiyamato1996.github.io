		...
		<section className="hero outer">
			<div className="container">
				<div className="offer">
					...
					<p>
						Киберспортивный онлайн турнир для учащихся колледжей и школ Северска по дисциплине CS:GO. <br />Генеральный партнёр турнира –<br />ОГБПОУ Северский промышленный колледж.
					</p>
				</div>
